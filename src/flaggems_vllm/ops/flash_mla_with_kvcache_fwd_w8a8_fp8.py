...
from flaggems_vllm.ops.flash_mla import (
    ...
    flash_mla_split_weight,
    tle,
)
from flaggems_vllm.ops.flash_mla_fp8_tiles import (
    _publish_p_fp8_sw64_coupled_stmatrix,
    _vtranspose_fp8_64x128,
    _vtranspose_fp8_64x128_kperm,
    _vtranspose_fp8_64x128_plain,
...
if HAS_TLE:
    ...
    def _triton_fp8_splitk_combine_kernel(
        ...
        for split_base in tl.range(0, split_count, BLOCK_SPLITS):
            ...
            weights = tl.where(
                finite_lse,
                flash_mla_split_weight(local_lse2, safe_max, True),
                0.0,
            )
            partial = tl.load(
                partial_out_ptr
